        ...
        <div className=' navBg w-screen h-[80px] z-10 bg-transparent fixed drop-shadow-lg'>
            <div className='px-2 flex justify-between items-center w-full h-full'>
                ...
                <div className='flex pr-4'>{
                    user ?
                        <>
                            <button className='border-none text-lg bg-transparent text-white mr-4' onClick={onLogout}>Logout</button>
                        </>
                    :
                        <>
                            <button className='border-none bg-transparent text-lg text-white mr-4'>
