module.exports = [
    {
        ...
        pasos: [
            "Practice your rocker turn by starting on a right forward inside edge with your arms over the circle",
            "Once you’re on your edge, press the big toe and rock up to the front of the blade to initiate the turn, rotating over your left shoulder, inside the circle",
            "To exit the turn on the correct edge, continue pressing the big toe, and let the back inside edge curve away from the circle you started on.",
            "Practice your back counter turn by starting on a right back inside edge, with your arms over the circle",
            "Since this turn is going from backwards to forward, we’ll want to press our heal to flip our toes around and turn forward as we begin to execute this turn",
            "Remain on an inside edge as you turn forward, again pressing the big toe the whole time and feel yourself curve away from your original circle",
    ...
    },
    {
        ...
        pasos: [
            "After winding up with our back crossover, we step forward onto our heel on a left forward outside edge, keeping our left arm in front",
            "We increase our knee bend and rock up to the toe of the blade in order to hook and center the spin, keeping our left arm in front, and bringing our right side around to the front",
            "Once we are spinning, we then take our right leg and reach it back behind us, turning our knee out, I like to think of it as a scorpion’s tail, but side ways!",
            "Now it’s time to push our hips as forward as they can go, this is the foundation of the layback.",
    ...
    },
    {
        ...
        pasos: [
            "The only difference in the entrance from our solo spin, is that we are starting a camel, so we must have our upper body a little more forward, bent over with a flat back",
            "Then as we initiate our 3-turn to start the spin, we rise up in our skating knee, achieving and maintaining a camel position, keeping the left arm in front at all times",
            "Now to go from camel, to sit. We must first start to bring our upper body slightly up in order to initiate the change of position",
            "Then we swing our right leg and arm around to meet in our center, bending our skating knee and ankle to achieve the 90 degree angle to get a legal sit spin",
    ...
    },
    {
        ...
        pasos: [
            "Once you reach the point of the 3-turn after you perform your entry into this spin, you want to swing your right leg around yourself",
    ...
    },
    {
        ...
        pasos: [
            "Start by gliding backwards on a right back outside edge, arms outside the circle",
            "Step onto a left forward outside edge, making sure you step closer to the heel of the blade",
            "As you step, your arms and your right leg will pull back, as you rock up to the toe pick for take off, your arms and free leg will follow, reaching their peak as we hit our toe pick to take off forward, with the left arm going slightly across the body to the right",
    ...
    },
    {
        ...
        pasos: [
            "We start on our right back outside edge, being extremely stacked over our right side, left shoulder, arm, and leg in front",
            "Now we have to curve off our circle, one of three. In order to do this, we must increase our knee bend without releasing the left side",
    ...
    },
    {
        ...
        pasos: [
            "After we step forward from the same right back outside edge we took for our axel, we make sure that our left arm is in front as we begin to do this 3-turn that will decide our timing for this jump.",
            "As we turn, our right arm comes to meet the left, only to quickly be pulled back upon completion of the turn, in order to strongly check over our right side with our right leg also remaining back behind us",
            "As this is also an edge jump, we must curl off our circle, this is done with knee and ankle bend.",
    ...
    },
    {
        ...
        pasos: [
            "After we have done our preferred entry steps, we are loading over our right leg, with a strong check to our right side, which we plan on landing on",
            "We have to reach back with our left foot, striking the ice with our toe pick, requiring us to point it somewhat to make sure we anchor ourselves properly",
            "With our left arm in front, it’s easy to think about this jump as starting by getting our left hand, and left foot, as far away from each other as possible, only to draw together to create rotation",
            "As we draw the right foot to the left pick, it’s important we bring the HEEL through, and not turn forward before we launch into the air too much, this will result in a big deduction as it is a common mistake called a toe-axel",
    ...
    },
    {
        ...
        pasos: [
            "After we execute our 3-turn, similar to the 3-turn for our salchow, we must bend our left knee to load, this combined with straight right leg extended behind us, will help dictate where we want to place our pick in the ice.",
            "As we tap our right to pick into the ice, we want to keep some weight on our left foot as we draw it to our right picking foot, because if we shift our weight too early, we will be completely off axis!",
    ...
    },
    {
        ...
        pasos: [
            "After landing the salchow in our eagle position, we have to open up slightly, but extremely to the right.",
